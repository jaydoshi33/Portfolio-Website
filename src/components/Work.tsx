...
const projects: Project[] = [
  {
    id: 1,
    title: 'AUTOVERIFY - Multi-Agent GenAI Fact Verification',
    description: 'A sophisticated multi-agent AI system designed to detect, verify, and correct hallucinations in generative AI systems.',
    tags: ['Python', 'LangChain', 'RAG', 'OpenAI', 'Multi-Agent', 'Streamlit'],
    category: 'ai',
    image: '/autoverify.png',
    github: 'https://github.com/jaydoshi33/AutoVerify',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: 'Social Media Misinformation Hotspot Detection',
    description: 'A system that detects misinformation hotspots on social media platforms using Social Media data mining and machine learning.',
    tags: ['Python', 'NLP', 'Machine Learning', 'Social Media', 'Data Analysis'],
    category: 'ai',
    image: '/smdm.png',
    github: 'https://github.com/jaydoshi33/Viral-Misinformation-Community-Detection',
  },
  {
    id: 4,
